                    ...
                    <div className="  vertical-align-middle">
                        <div className='auth-box mt-5 '>
                            <div className="content">  
                                <h3>Rejected Leave Lists</h3>
                              {loader ?  <div>
                            {
                            users.length===0 ? <div className="alert-msg"><h5>No Rejected Leaves Today</h5><i class="fa fa-times" aria-hidden="true"></i></div> :
                            users.map((user)=>(
                                     <div className="employee-data" onClick={()=>{Navigate(`/adminrejectedleaves/${user.employeeId}`)}}>
