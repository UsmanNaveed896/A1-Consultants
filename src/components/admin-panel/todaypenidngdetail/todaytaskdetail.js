...
export default () => {
    ...
    const loadUsers = async () => {
        ...
        const result = await axios.get(`https://crm-09.herokuapp.com/task/taskStatus?date=${date}&st=pending`, headers);
                        ...
                        <div className='auth-box mt-5 '>
                            <div className="content">
                                <div className="yesterday-task">
                                    <div><h4>Today Pending Tasks Detail</h4></div>
                                     <div className="action-btn">
                                    <button type="submit" className="btn btn-danger" onClick={()=>Navigate('/admin/pendingtasks/monthly')}>Monthly Pending Tasks</button>
                                    </div>
                                </div>
